...
### Output
8: 
- ['Fams Below Pov %', 'Ppl (<150% Of Pov) %', "% At Least Bachelor's Degree", 'Language Isolation %']
...
18: 
- ['Fams Below Pov %', 'Ppl (Below Poverty) %', "% At Least Bachelor's Degree", 'Language Isolation %']
...
29: 
- ['Fams Below Pov %', "% At Least Bachelor's Degree", 'Median Household Income (Scaled)', 'Language Isolation %']
...
30: 
- ['Fams Below Pov %', "% At Least Bachelor's Degree", 'Vast Majority Income (Scaled)', 'Language Isolation %']
...
50: 
- ['Ppl (<150% Of Pov) %', "% At Least Bachelor's Degree", 'Vast Majority Income (Scaled)', 'Language Isolation %']
- Mean r^2 score accross 5 folds for RandomForestRegressor(): 0.522
- All fold scores for RandomForestRegressor(): [ 0.38042699  0.67644018  0.73737917  0.89219223 -0.0761083 ]

60: 
- ['Ppl (Below Poverty) %', "% At Least Bachelor's Degree", 'Vast Majority Income (Scaled)', 'Language Isolation %']
